class Element {
  constructor(formula) {
    ...
    this.formula = formula.replaceAll(/\s/g, '').replace("Aq","aq").replace("AQ","aq").replace("aQ", "aq").replaceAll("_","").replaceAll("(","").replaceAll(")","").replaceAll("\\left","").replaceAll("\\right","").split("^")[0];
    this.proced = [];
    this.aq = false;
    if (formula.split("^").length > 1)
      this.superIndex = parseInt(formula.split("^")[1].substring(1, formula.length-2));
    else
      this.superIndex = 0;
  }
  ...
  findGroup() {
    ...
    else if ( e[0] == "H" && e.length / 2 == 2 && (e.indexOf("F") >= 0 || e.indexOf("Cl") >= 0 || e.indexOf("Br") >= 0 || e.indexOf("I") >= 0 || e.indexOf("S") >= 0 || e.indexOf("Se") >= 0 || e.indexOf("Te") >= 0)) {
    ...
    else if (e.length / 2 == 2 && e.indexOf("H") >= 0 && (e.join("") == "B1H3" || e.join("") == "C1H4" || e.join("") == "Si1H4" || e.join("") == "N1H3" ||e.join("") == "P1H3" || e.join("") =="As1H3"||e.join("") == "Sb1H3" || e.join("") =="Bi1H3")) {
    ...
    else if (e.length / 2 == 2 &&  (e.indexOf("F") > 0 || e.indexOf("Cl") > 0 || e.indexOf("Br") > 0 || e.indexOf("I") > 0 || e.indexOf("S") > 0 || e.indexOf("Se") > 0 || e.indexOf("Te") > 0)){
      console.log("combBin");
